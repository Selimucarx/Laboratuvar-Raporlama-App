...
public class LaborantSpecifications {
    ...
    public static Specification<Laborant> withDynamicQuery(String searchQuery) {
        return (root, query, cb) -> {
            ...
            Predicate nationalNumberPredicate = cb.like(cb.lower(root.get("hospitalNumber")), likePattern);
